...
function InquiryWrite() {
    ...
    const hotelVal = ["서울가야호텔", "제주가야호텔", "가야스테이 광화문", "가야스테이 마포", "가야스테이 서대문", "가야스테이 역삼", "가야스테이 서초", "가야스테이 구로", "가야스테이 삼성", "가야스테이 동탄", "가야스테이 천안", "가야스테이 울산", "가야스테이 해운대", "가야스테이 서부산", "가야스테이 여수", "가야스테이 제주"];
