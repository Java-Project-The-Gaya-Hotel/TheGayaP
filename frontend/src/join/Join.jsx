        ...
        <div className={"contain"}>
            ...
            <form onSubmit={onSubmitHandler}>
                ...
                <div className={"container"}>
                    <div className={"row"}>
                        <div className={"col"}><h3>회원정보</h3></div>
                        <hr/>
                        <div className={"row"}>
                            <div className={"col"}><h5>기본정보</h5></div>
                            <div className={"col text-end"}><p><em className="ast">*</em> 표시 필수입력 사항</p></div>
                        </div>
                        ...
                        <table className={"tableTypeA"}>
                            ...
                            <tr className={"first"}>
                                ...
                                <td>
                                    <div className="first ">
                                        <input type={"text"} value={id} onChange={onIdHandler} onClick={handleIds} className={"id"} autoComplete={"off"}/>
