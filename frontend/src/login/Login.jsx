...
function Login() {
    return (
        <div className={"container mt-5 py-4 vh-100"}>
            ...
            <div className={"d-grid justify-content-center col-md-8 mx-auto"}>
                        ...
                        <div className={"d-grid justify-content-center"}>
                            <div className={""}>
                                <div className={"d-flex"}>
                                    ...
                                    <button className={"btn btn-secondary btn-lg mx-4"} style={{borderRadius: 0}}>로그인
                                    </button>
                                </div>
                                <div className={"d-flex"}>
                                    <input type={"checkbox"}/>
                                    <label className={""}>가야 리워즈 번호 또는 아이디 저장</label>
                                </div>
                            </div>
                            <div className={"d-flex"}>
                                <button className={"btn btn-dark"} style={{borderRadius: 0}}>가야 리워즈 가입</button>
                                <button className={"btn btn-secondary"} style={{borderRadius: 0}}>가야 리워즈 번호 또는 아이디 찾기
                                </button>
                ...
                <div className={"bg-opacity-10 bg-dark text-center mt-3"}>
                    <p className={"text-center m-2"}>이메일, 연락처 등의 정보가 변경되면 웹사이트에서 회원정보를 수정해주시기 바랍니다.</p>
                </div>
            </div>
        </div>
    );
